...
package com.dev.leo.testusers.data.models;
...
public class Result implements Parcelable {
    ...
    public static DiffUtil.ItemCallback<Result> DIFF_CALLBACK = new DiffUtil.ItemCallback<Result>() {
        @Override
        public boolean areItemsTheSame(@NonNull Result search, @NonNull Result t1) {
            return search.getLogin().getUuid().equalsIgnoreCase(t1.getLogin().getUuid());
        }

        @Override
        public boolean areContentsTheSame(@NonNull Result search, @NonNull Result t1) {
            return search.getLogin().getUuid().equalsIgnoreCase(t1.getLogin().getUuid());
        }
    };
